...
In this section, we detail the particle identification and selection using the CLAS12 detector. We focus on the measurement of electrons in the forward detector and charged pions in the forward and central detectors. Particle identification and refined selection follow procedures developed by Run Group A.

Data has been taken from Pass1 with a beam energy of 10.54 GeV and has been produced with CLAS12 software \href{https://github.com/JeffersonLab/coatjava/releases/tag/13.0.0}{COATJAVA 13.0.0}. The data are availiable at \texttt{/cache/clas12/rg-d/production/Pass1/}.
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{images/electron/Vz_CxC_OB.pdf}
\caption{$V_z$ distribution for electrons in outbending polarity for the CxC target, showing the total fit and individual components.}
\label{fig:Vz-electron-CxC}
\end{figure}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.7\textwidth]{images/electron/plots_calorimeter_fiducials/target_comparison/lv_vs_sf_S1_target_comparison.pdf}
